...
export default function EventDetails() {
    ...
    return (
        <div style={{ display: "flex", width: "80%", alignItems: "center", justifyContent: "center" }}>
            ...
            <div key={event._id} className="EventDetails" style={{ width: '60%', minHeight: "fit-content", border: '1px #DDE1E6 solid', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex', margin: "15px", minHeight: "100%" }}>
